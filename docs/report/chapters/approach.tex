...
% State machine ของวิธีการนับจากข้อมูลของเซนเซอร์ โดยแบ่งเซนเซอร์ที่อยู่ใกล้ทางเดินภายในรถเป็น IN และ เซนเซอร์ที่อยู่ใกล้ประตูรถเป็น OUT แยกกันนับในแต่ละประตู ซึ่งหากวัตถุอยู่ใกล้เซนเซอร์วัดระยะทาง น้อยกว่าหรือเท่ากับ ที่กำหนดไว้ผ่านตัวต้านทานแบบปรับค่าได้ (POT …) จะนับว่ามีวัตถุ (1) นอกจากนั้นจะนับว่าไม่มีวัตถุ (0) โดยจาก State Machine จะนับการ เข้า/ออกที่สถานะ IN/OUT ตามลำดับ
...
\begin{figure}[h!]
    \begin{center}
      \includegraphics{exchange-data.png}
    \end{center}
